  ...
  ipcMain.handle("excel-report-download", async (event, caseId) => {
    ...
    try {
      ...
      try {
        ...
        const serverEndpoint = `${baseUrl}/excel-download/`;
      ...
      try {
        ...
        readStream.on("end", () => {
          ...
          event.sender.send("excel-report-complete", {
        ...
        readStream.on("error", (err) => {
          ...
          event.sender.send("excel-report-error", {
        ...
        event.sender.send("excel-report-error", {
          error: "Error processing the report",
        });
      }
    } catch (err) {
