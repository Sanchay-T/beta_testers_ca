...
CREATE TABLE `__new_tally_voucher` (
	...
	`result` integer,
	`created_at` integer DEFAULT 1746599913043 NOT NULL,
...
CREATE TABLE `__new_transactions` (
	...
	`created_at` integer DEFAULT 1746599913030 NOT NULL,
...
ALTER TABLE `cases` ADD `deleted` integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE `statements` DROP COLUMN `deleted`;