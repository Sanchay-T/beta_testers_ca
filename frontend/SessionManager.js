...
class SessionManager extends EventEmitter {
    constructor() {
        ...
        console.log('✅ [SESSIONMANAGER] Instance created successfully');
    }
...
console.log('✅ [SESSIONMANAGER] Class defined successfully');
module.exports = SessionManager;
console.log('✅ [SESSIONMANAGER] Export completed successfully');