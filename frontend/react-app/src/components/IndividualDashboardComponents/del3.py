def Upi(df):
    ...
    df["Category"] = df.apply(apply_regex_to_categories_uco, axis=1)
    df["Category"] = df.apply(apply_regex_to_categories_nkgsb, axis=1)
    df["Category"] = df.apply(apply_regex_to_categories_surat, axis=1)
    df["Category"] = df.apply(apply_regex_to_categories_idfc, axis=1)
    df["Category"] = df.apply(apply_regex_to_categories_jsbl, axis=1)
    ...
    df["Category"] = df.apply(apply_regex_to_categories_dcb, axis=1)
